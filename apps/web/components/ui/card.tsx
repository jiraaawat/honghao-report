...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn('text-lg font-mono font-semibold leading-none tracking-tight text-zinc-100', className)}
      {...props}
    />
  )
)
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn('text-sm font-mono text-zinc-400', className)}
    {...props}
  />
))
