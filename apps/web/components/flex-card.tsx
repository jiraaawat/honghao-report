    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold uppercase tracking-widest text-zinc-400">FLEX</span>
        </div>
        <span className="text-[10px] text-zinc-500">honghao report</span>
      </div>
      ...
      <div className="mt-6 flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-xs text-zinc-400">total profit</div>
        </div>
      </div>

      <div className="mt-6 grid grid-cols-2 gap-3 text-xs">
        <div className="rounded-lg border border-zinc-800 bg-zinc-950/50 p-3">
          <div className="text-zinc-500">profit / card</div>
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-950/50 p-3">
          <div className="text-zinc-500">cost / card</div>
          <div className="mt-1 text-base font-bold text-zinc-200">{formatCurrency(avgCost)}</div>
        </div>
        <div className="rounded-lg border border-zinc-800 bg-zinc-950/50 p-3">
          <div className="text-zinc-500">sell / card</div>
